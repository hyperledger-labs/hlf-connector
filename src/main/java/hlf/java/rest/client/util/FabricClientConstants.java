...
public class FabricClientConstants {
  ...
  public static final String CHANNEL_CONFIG_POLICY_TYPE_LIFECYCLE_ENDORSEMENT =
  ...
  public static final String JSON_PATH_POLICY_TYPE_ONE_VALUE =
      "$..['policy'][?(@['type'] == " + 1 + ")]";
  public static final String JSON_PATH_POLICY_TYPE_THREE_VALUE =
      "$..['policy'][?(@['type'] == " + 3 + ")]";
  ...
  public static final String JSON_PATH_BLOCKHASHINGALGORITHM_VALUE =
